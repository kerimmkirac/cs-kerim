...
class FullHDFilmizlesene : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "${mainUrl}/filmizle/macera-filmleri-fhd-izle" to "Macera Filmler",
        ...
        "${mainUrl}/filmizle/romantik-filmler-fhd-izle" to "Romantik Filmleri",
        ...
        "${mainUrl}/seri-hd-filmler" to "Film Serileri"
    )
